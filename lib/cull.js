...
var cull = (function () {
    ...
    function some(fn, seq) {
        return reduce(function (memo, i) { return memo || fn(i); }, false, seq);
    }
    ...
    doall(function (tagName) { el[tagName] = partial(el, tagName); }, [
        "a", "br", "div", "fieldset", "form", "h2", "h3", "h4", "h5",
        "img", "input", "label", "li", "p", "span", "strong", "textarea",
        "ul", "span", "select", "option", "ol", "iframe"
    ]);
